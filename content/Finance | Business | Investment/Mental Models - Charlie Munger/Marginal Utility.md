...
- Traditional vacuum: cleans dust off the floor
    
- **Marginal utility of 1st Dyson use**: "Whoa, it cleans more deeply and is easy to move."  
    → Users get **_visible_, _emotional_ satisfaction the first time**.
...
> 🧠 Dyson **doesn’t just make it “better”** — they make every upgrade solve the _next real pain point_, so people **actually feel the improvement**.
...
- First-time user learns basic words → “Wow, I can say ‘hello’ in Spanish!”
    
- **First unit satisfaction is high** because it feels easy and encouraging.
...
| **Leaderboards**               | Adds competition/social proof                       | Creates _social motivation_ → users stay longer, feel satisfaction from improving relative to peers           |
| **Stories & mini-games**       | Feels fresh, more engaging than repetition          | Reduces boredom/fatigue → _additional sessions feel novel_, not repetitive (diminishes diminishing returns)   |
| **Speech practice**            | Covers _real pain point_ = “I want to speak better” | Makes learning more **practical & real-world applicable** → later use gives **more meaningful value**         |
| **Premium (no ads + offline)** | Removes annoyance + adds flexibility                | Improves experience with _each session_ → every new use feels smoother, faster → **more enjoyable over time** |

> Duolingo understands:  
> “At some point, flashcards get boring. So what’s next?”  
> Every new feature is **timed** to solve the user’s _next motivation dip_.
...
Through these two examples I can feel they indeed have high Marginal Utility, they first have a great MVP that can solve people's real pain points, and people can really feel the problems be solved, the progress is clear, it is practical.
Then they added more features , each feature people can actually feel the improvement or motivate people more to use it, give more satisfaction.
...
- Base app: lets you create and search notes instantly.
    
- **Core utility:** “Find any note in 0.5s”
    
- Satisfaction score (1–10): 8. Users say, “I can’t live without lightning-fast search.”
...
1. **Auto-tagging**: the app reads your note and suggests tags.
    
2. **Version history**: roll back edits to any prior draft.
    
3. **Smart summaries**: AI generates a one-paragraph summary of each note.
    
4. **Collaboration**: share/live-edit notes with teammates.
...
- **Free (Core):** Create & search (satisfaction = 8)
    
- **Pro (Tier 2):** + Auto-tagging + Version history (satisfaction ≈ 10)
    
- **Premium (Tier 3):** + Smart summaries + Collaboration (satisfaction ≈ 12)
...
- Pro → $5/mo (users see 2 extra points of value)
    
- Premium → $12/mo (another 2 points)
...
- Release Auto-tagging to 10% of power users.
    
- Survey: “Rate your search experience now.” Score jumps from 8→9.
    
- You build the full version—auto-tagging now reliably gives +2 satisfaction.
...
- **Collaboration:** every new teammate adds value for you; marginal utility increases as your network grows.
    
- **Daily Reminders:** streaks nudge you to use the app daily—each day you use it, your note-taking habit (and perceived value) compounds.
...
- “Upgrade to Pro and **save 30 minutes/week** with auto-tagging!”
    
- “Go Premium for **AI Summaries**—get a one-paragraph brief of every long note.”
...
This even break down the steps by steps, much clear for me.
I like No7, we should express our improvements clearly for customers and try to make their understanding more easier.
